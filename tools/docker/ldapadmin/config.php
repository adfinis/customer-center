 ...
 */
 $config->custom->session['blowfish'] = '*FbLJ+((f7NK_`Ut>.)5{B+Bc @AtY4I:ti8rCGXXdYO)ycQ8$A,=24Y,)#vn4}n';
...
$servers->setValue('login','bind_id','cn=admin,dc=adsy-ext,dc=becs,dc=adfinis-sygroup,dc=ch');
$servers->setValue('login','bind_pass','123qwe');
